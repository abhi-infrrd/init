...
def CPA_preprocessing():
    logger.info('Preprocessing hybrid recommender data')
...
def CPA_recommender_initialise():
    logger.info('initialising hybrid recommeder')
    # Preprocess CPA Data
    ...
    # Train the CPA recommender
    model = train_hybrid_recommender(Mui_tr, Mui_if, Mui_uf)
    
    # Returns all necesary variables
    return(model, d_ui, courses_with_metadata_index, 
           courses_with_metadata, products_with_metadata_index, 
           products_with_metadata, dictionary_courses_with_metadata, 
           dictionary_products_with_metadata)
